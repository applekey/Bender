...
void main(void)
{
	...
	if(mode == 0)
	{
		filteredImage += cos(texture(wrapImage, fragTexCoordOffset[ 0]))*0.0031;
		filteredImage += cos(texture(wrapImage, fragTexCoordOffset[ 1]))*0.0044;
		filteredImage += cos(texture(wrapImage, fragTexCoordOffset[ 2]))*0.0058;
		filteredImage += cos(texture(wrapImage, fragTexCoordOffset[ 3]))* 0.0069;
		filteredImage += cos(texture(wrapImage, fragTexCoordOffset[ 4]))* 0.0076;
		filteredImage += cos(texture(wrapImage, fragTexCoordOffset[ 5]))* 0.0087;
		filteredImage += cos(texture(wrapImage, fragTexCoordOffset[ 6]))* 0.0076;
		filteredImage += cos(texture(wrapImage, fragTexCoordOffset[ 7]))*0.0069;
		filteredImage += cos(texture(wrapImage, fragTexCoordOffset[ 8]))* 0.0058;
		filteredImage += cos(texture(wrapImage, fragTexCoordOffset[ 9]))* 0.0044;
		filteredImage += cos(texture(wrapImage, fragTexCoordOffset[10]))*0.0031;
	}
	else
	{
